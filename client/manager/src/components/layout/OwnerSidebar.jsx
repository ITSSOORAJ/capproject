...
const OwnerSidebar = ({ isOpen, toggleSidebar, className }) => {
  ...
  const navItems = [
    ...
    { to: "/manager/turfs", label: "My Turfs", icon: MapPin },
    { to: "/manager/add-turf", label: "Add Turf", icon: PlusCircle },
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-4 border-b">
        <span className="text-xl font-semibold">Manager Dashboard</span>
