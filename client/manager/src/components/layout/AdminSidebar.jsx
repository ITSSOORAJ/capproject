...
const AdminSidebar = ({ isOpen, toggleSidebar, className }) => {
  ...
  const navItems = [
    { to: "/admin", label: "Dashboard", icon: Home },
    {
      ...
      icon: UserPlus,
      subItems: [
        { to: "/admin/manager-requests/new", label: "New Requests" },
        { to: "/admin/manager-requests/rejected", label: "Rejected Requests" },
      ],
    },
    { to: "/admin/users", label: "Users", icon: Users },
    { to: "/admin/managers", label: "Managers", icon: Building },
